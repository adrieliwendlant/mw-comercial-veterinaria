...
const IMG = {
  ...
  logo:          process.env.PUBLIC_URL+'/images/logo-mw.png',
  logoAvatar:    process.env.PUBLIC_URL+'/images/logo-instagram-avatar.jpg',
  logoFooter:    process.env.PUBLIC_URL+'/images/logo-mw-footer.png',

  products: {
    simparic:                    process.env.PUBLIC_URL+'/images/produtos/simparic.jpg',
    simparic_trio:               process.env.PUBLIC_URL+'/images/produtos/simparic-trio.jpg',
    ectofend:                    process.env.PUBLIC_URL+'/images/produtos/ectofend.jpg',
    revolution:                  process.env.PUBLIC_URL+'/images/produtos/revolution.jpg',
    revolution_plus:             process.env.PUBLIC_URL+'/images/produtos/revolution-plus.jpg',
    proheart:                    process.env.PUBLIC_URL+'/images/produtos/proheart.jpg',
    vanguard_plus:               process.env.PUBLIC_URL+'/images/produtos/vanguard-plus.jpg',
    vanguard_htlp:               process.env.PUBLIC_URL+'/images/produtos/vanguard-htlp.jpg',
    defensor:                    process.env.PUBLIC_URL+'/images/produtos/defensor.jpg',
    bronchiguard:                process.env.PUBLIC_URL+'/images/produtos/bronchiguard.jpg',
    vanguard_b_oral:             process.env.PUBLIC_URL+'/images/produtos/vanguard-b-oral.jpg',
    vanguard_i_iii:              process.env.PUBLIC_URL+'/images/produtos/vanguard-i-iii.jpg',
    giardiavax:                  process.env.PUBLIC_URL+'/images/produtos/giardiavax.jpg',
    felocell_felv:               process.env.PUBLIC_URL+'/images/produtos/felocell-felv.jpg',
    felocell_cvr:                process.env.PUBLIC_URL+'/images/produtos/felocell-cvr.jpg',
    felocell_cvr_c:              process.env.PUBLIC_URL+'/images/produtos/felocell-cvr-c.jpg',
    apoquel:                     process.env.PUBLIC_URL+'/images/produtos/apoquel.jpg',
    cytopoint:                   process.env.PUBLIC_URL+'/images/produtos/cytopoint.jpg',
    rimadyl_comp:                process.env.PUBLIC_URL+'/images/produtos/rimadyl-comp.jpg',
    rimadyl_inj:                 process.env.PUBLIC_URL+'/images/produtos/rimadyl-inj.jpg',
    ...
    cerenia_comp:                process.env.PUBLIC_URL+'/images/produtos/cerenia-comp.jpg',
    synulox:                     process.env.PUBLIC_URL+'/images/produtos/synulox.jpg',
    ...
    uranotest_cinomose:          process.env.PUBLIC_URL+'/images/produtos/uranotest-cinamose-adenovirus.jpg',
    uranotest_dirofilariose:     process.env.PUBLIC_URL+'/images/produtos/uranotest-dirofilariose.jpg',
    uranotest_felv_fiv:          process.env.PUBLIC_URL+'/images/produtos/uranotest-felv-fiv.jpg',
    uranotest_giardia:           process.env.PUBLIC_URL+'/images/produtos/uranotest-giardia.jpg',
    uranotest_parvo:             process.env.PUBLIC_URL+'/images/produtos/uranotest-parvovirus-coronavirus.jpg',
  },

  // Fachada da sede em Santa Rosa
  fachada:       process.env.PUBLIC_URL+'/images/fachada.jpg',

  // Foto da equipe (evento Conexão MW)
  equipe:        process.env.PUBLIC_URL+'/images/equipe.jpg',

  // Fotos individuais da equipe (quadradas, mínimo 200x200px)
  team: {
    marcos:      process.env.PUBLIC_URL+'/images/team/marcos.jpg',
    adrieli:     process.env.PUBLIC_URL+'/images/team/adrieli.jpg',
    taysa:       process.env.PUBLIC_URL+'/images/team/taysa.jpg',
    bibiana:     process.env.PUBLIC_URL+'/images/team/bibiana.jpg',
    kauana:      process.env.PUBLIC_URL+'/images/team/kauana.jpg',
    ...
    bruna:       process.env.PUBLIC_URL+'/images/team/bruna.jpg',
    claudia:     process.env.PUBLIC_URL+'/images/team/claudia.jpg',
    giovani:     process.env.PUBLIC_URL+'/images/team/giovani.jpg',
    isabela:     process.env.PUBLIC_URL+'/images/team/isabela.jpg',
    joana:       process.env.PUBLIC_URL+'/images/team/joana.jpg',
  ...
  instagram: [
    process.env.PUBLIC_URL+'/images/instagram/post1.jpg',
    process.env.PUBLIC_URL+'/images/instagram/post2.jpg',
    process.env.PUBLIC_URL+'/images/instagram/post3.jpg',
    process.env.PUBLIC_URL+'/images/instagram/post4.jpg',
  ],
};
...
const PRODUCTS = [
  ...
  { id:26, name:'Torbugesic®',                  brand:'Zoetis', cat:'anest',      sp:['dog','cat'], img:'torbugesic',                      desc:'Analgésico opioide à base de butorfanol para alívio de dor.',                                                                   link:`${BASE}/caes/anestesia-e-sedacao/torbugesic/` },
  ...
  { id:28, name:'Cerenia® Injetável',           brand:'Zoetis', cat:'antiemetic', sp:['dog'],       img:'cerenia_inj',                      desc:'Antiemético injetável à base de maropitant. Previne e trata o vômito agudo em cães.',                                           link:`${BASE}/caes/vomito-e-enjoo/cerenia/` },
  { id:29, name:'Cerenia® Comprimidos',         brand:'Zoetis', cat:'antiemetic', sp:['dog'],       img:'cerenia_comp',                      desc:'Antiemético oral à base de maropitant. Eficaz na prevenção do enjoo do movimento em cães.',                                     link:`${BASE}/caes/vomito-e-enjoo/cerenia/` },
  { id:30, name:'Synulox®',                     brand:'Zoetis', cat:'other',      sp:['dog','cat'], img:'synulox',                      desc:'Antimicrobiano composto por amoxicilina e clavulanato de potássio.',                                                            link:`${BASE}/caes/antibioticos/synulox/` },
